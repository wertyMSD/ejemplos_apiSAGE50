...
if __name__ == "__main__":
    ...
    modelo=api50.pre_compra()
    modelo["Cabecera"]["Proveedor"]="400000000"
    modelo["Lineas"][0]["Unidades"] = 10
    modelo["Lineas"][1]["Precio"] = 100
    modelo["Porte"]["Agencia"] = "Seu"

    print("Creado Presupuesto ",api50.pre_compra(modelo))
    print("Creado Pedido ",api50.ped_compra(modelo))
    print("Creado Albaran ",api50.alb_compra(modelo))
