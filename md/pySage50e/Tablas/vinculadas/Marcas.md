...
```
lista=api50.mark(wlista="Efectivo!=1")
...
[GitHub](https://github.com/wertyMSD/ejemplos_apiSAGE50/blob/master/vinculados-marca.py)   
   
[Lista Campos disponibles ](https://github.com/wertyMSD/ejemplos_apiSAGE50/blob/master/marca.txt)